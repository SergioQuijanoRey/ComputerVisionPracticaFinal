...
En un primer momento, comenzaremos generando los triples (\emph{anchor}, \emph{positive}, \emph{negative}) de forma aleatoria entre las imágenes de la base de datos. Para ello establecemos un número máximo de triples que usaremos para entrenar, pues todas las combinaciones posibles serían inabarcables. 

\subsection{Resultados del entrenamiento}

\subsection{Adaptación a una tarea de clasificación}

Una vez entrenada la red con los triples aleatorios, vamos a construir un clasificador usando kNN. Para ello vamos a calcular los embeddings de todas las imágenes del dataset con la Red entrenada y utilizaremos estos dato 
